package com.company.toolstorageroom.test_support;
 ...
 */
@SpringBootTest
@UiTest(authenticatedUser = "admin", mainScreenId = "MainScreen", screenBasePackages = "com.company.toolstorageroom.screen")
@ContextConfiguration(classes = {ToolStorageRoomApplication.class, UiTestAssistConfiguration.class})
