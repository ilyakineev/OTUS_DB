...
[Скрипты создания схемы и таблиц БД](../postgresql/postgreSqlScript.sql)
...
## 2. Определяем возможную кардинальность поля:
...
* _time_ - Время выполнения операции, timestamp NOT NULL (Поле обязательное для заполнения)
